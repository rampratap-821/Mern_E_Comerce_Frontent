...
import shopping from '../../assets/loading.json'
...

                                {
                                    filterData.map((data) => (
                                        ...
                                        >
                                            ...
                                            {/* Card */}
                                            <div className="bg-gradient-to-br from-black via-gray-900 to-black backdrop-blur-lg rounded-2xl overflow-hidden shadow-2xl hover:shadow-cyan-400/30 transition-all duration-500 hover:-translate-y-2 border border-cyan-400/20">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <Link to={`/product/${data._id}`}>
                                                        ...
                                                        <h2 className="text-[17px] font-bold text-white leading-snug line-clamp-2 hover:text-cyan-300 transition duration-300">
                                                            {data.title}
                                                        </h2>
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full mt-5 bg-gradient-to-r from-cyan-400 via-blue-500 to-blue-700 hover:scale-[1.02] text-white py-2.5 rounded-xl font-semibold text-[15px] transition-all duration-300 shadow-lg hover:shadow-cyan-400/40"
                                                    >
                                                        Add To Cart
                                                    </button>
