        ...
        <div className='min-h-screen bg-gray-100 px-4 py-8'>
            ...
            <div className='container mx-auto max-w-7xl'>
                ...
                <div className='flex justify-center mb-10'>
                    ...
                    <button className='bg-gradient-to-r from-blue-700 via-blue-500 to-sky-400 text-white font-bold px-7 py-3 rounded-lg shadow-lg shadow-blue-500/30 hover:scale-105 transition-all duration-300'>
                        Register User = {register?.user?.length}
                    </button>
                ...
                <div className='space-y-6'>

                    {
                        register?.user?.map((item) => (
                            ...
                            <div
                                key={item._id}
                                className='relative overflow-hidden rounded-2xl border border-blue-500/20 bg-white p-8 shadow-xl hover:shadow-blue-500/20 hover:border-blue-400 transition-all duration-300 group'
                            >

                                {/* Glow Effect - Blue */}
                                <div className='absolute top-0 right-0 w-52 h-52 bg-blue-500/10 blur-3xl rounded-full group-hover:bg-blue-500/20 transition-all duration-500'></div>

                                {/* Content */}
                                <div className='relative z-10 flex flex-col items-center text-center'>

                                    {/* Avatar - Blue Gradient */}
                                    <div className='w-20 h-20 rounded-full bg-gradient-to-r from-blue-700 via-blue-500 to-sky-400 flex items-center justify-center text-3xl font-bold text-white shadow-lg shadow-blue-500/30 mb-5'>
                                        {item?.name?.charAt(0).toUpperCase()}
                                    </div>
                                    ...
                                    {/* Email */}
                                    <h2 className='text-xl text-gray-600 font-medium mt-3'>
                                        {item?.email}
                                    </h2>
                                    ...
                                    <div className='w-40 h-[3px] bg-gradient-to-r from-blue-700 via-blue-500 to-sky-400 rounded-full mt-6'></div>
